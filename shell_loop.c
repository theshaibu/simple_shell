...
/**
 * hsh - Main shell loop responsible for reading input, processing commands,
 *       and executing either built-in commands or external commands.
...
/**
 * find_cmd - Finds the command in the PATH or executes it directly.
 * @info: The parameter and return info struct.
 *
 * Return: void.
 */
